...
Avoid author to edit/deleting his internal note if the note mentions someone""",
    'summary_vi_VN': """
Tránh để tác giả chỉnh sửa / xóa ghi chú nội bộ của mình nếu ghi chú đề cập đến ai đó
""",

    'description': """
What it does
============
* This module is used to avoid author to edit/deleting his internal note in any documents and his message in channel if the note/message mentions someone
...
Ứng dụng này làm gì
===================
* Mô-đun này được sử dụng để tránh tác giả chỉnh sửa/xóa ghi chú nội bộ của họ trong bất kỳ tài liệu nào và tin nhắn của họ trong kênh nếu ghi chú/tin nhắn đề cập đến ai đó
